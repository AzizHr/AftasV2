...
public interface RankingService {
    RankingResponse save(RankingRequest rankingRequest) throws NotFoundException, AlreadyAMemberException;
    ...
    List<RankingResponse> findAllByCompetitionCode(String competitionCode);
